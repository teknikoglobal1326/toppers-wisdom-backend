...
const { sendOtpSchema, verifyOtpSchema, refreshTokenSchema, updatePasswordSchema, updateProfileSchema, googleSignupSchema, loginSchema, forgotPasswordSchema, verifyResetOtpSchema, resetPasswordSchema } = require('./auth.schema')

router.post('/login', validate(loginSchema), controller.login)
router.post('/google-signup', validate(googleSignupSchema), controller.googleSignup)
