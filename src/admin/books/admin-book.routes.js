...
const { createBookSchema, createBookDualSchema, updateBookSchema, setBuyUrlSchema, listBookQuerySchema, listPurchasesQuerySchema } = require('./admin-book.schema')
...
router.get('/purchases', validateQuery(listPurchasesQuerySchema), controller.listPurchases)
