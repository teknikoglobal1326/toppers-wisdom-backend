...
const { createVocabSchema, updateVocabSchema, listVocabQuerySchema, importVocabSchema } = require('./admin-editorial-vocabulary.schema')
const { uploadVocabularyMedia, parseFormData, uploadBulkFile } = require('./admin-editorial-vocabulary.upload')

router.get('/', validateQuery(listVocabQuerySchema), controller.list)
router.get('/:id', controller.getOne)
router.post('/import', validate(importVocabSchema), controller.importVocabularies)
