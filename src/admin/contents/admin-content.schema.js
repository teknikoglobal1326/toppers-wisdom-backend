...
const createContentSchema = Joi.object({
  ...
  type: Joi.string().valid('video', 'youtube').default('video'),
  video: Joi.string().trim().when('type', { is: 'video', then: Joi.required(), otherwise: Joi.optional().allow('', null) }),
...
const updateContentSchema = Joi.object({
  ...
  description: Joi.string().trim().optional().allow('', null),
  type: Joi.string().valid('video', 'youtube').optional(),
  video: Joi.string().trim().optional().allow('', null),
