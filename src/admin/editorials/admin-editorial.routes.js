...
const { createEditorialSchema, updateEditorialSchema, listEditorialQuerySchema, upsertEditorialPlanSchema } = require('./admin-editorial.schema')
...
router.post('/plan', validate(upsertEditorialPlanSchema), controller.upsertPlan)
