...
const McqReportSchema = new mongoose.Schema({
    ...
    type: { type: String, enum: ['question', 'test', 'testSeries', 'previousYearPaper', 'previousYearTest', 'course-test', 'ai_test', 'live_test', 'quiz', 'math', 'editorial'], required: true, index: true },
